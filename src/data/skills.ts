...
export const academicKnowledgeSkills: SkillName[] = [
...
export const commonKnowledgeSkills: SkillName[] = [
...
export const performerSkills: SkillName[] = [
	"Performer (Acrobat)",
	"Performer (Actor)",
	"Performer (Clown)",
	"Performer (Comedian)",
...
export const secretLanguageSkills: SkillName[] = [
...
export const secretSignSkills: SkillName[] = [
...
export const arcaneLanguageSkills: SkillName[] = [
...
export const languageSkills: SkillName[] = [
...
export const tradeSkills: SkillName[] = [
	"Trade (Apothecary)",
	"Trade (Armourer)",
	"Trade (Artist)",
	"Trade (Aviarist)",
